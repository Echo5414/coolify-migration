...
load_env() {
  ...
  SOURCE_DOCKER_ROOT="${SOURCE_DOCKER_ROOT:-/var/lib/docker}"
  ...
  RESTORE_DOCKER_ROOT="${RESTORE_DOCKER_ROOT:-false}"
  MOVE_EXISTING_DEST_DOCKER_ROOT="${MOVE_EXISTING_DEST_DOCKER_ROOT:-false}"
  DOMAINS="${DOMAINS:-}"
